...
func New(c rest.Interface) *WardleV1alpha1Client {
	...
	return &WardleV1alpha1Client{restClients: clients}
}
...
func (c *WardleV1alpha1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *WardleV1alpha1Client) run() {
	go func(c *WardleV1alpha1Client) {
