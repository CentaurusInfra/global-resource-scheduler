...
func New(c rest.Interface) *CertificatesV1beta1Client {
	...
	return &CertificatesV1beta1Client{restClients: clients}
}
...
func (c *CertificatesV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *CertificatesV1beta1Client) run() {
	go func(c *CertificatesV1beta1Client) {
