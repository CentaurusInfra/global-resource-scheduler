...
func New(c rest.Interface) *SchedulingV1beta1Client {
	...
	return &SchedulingV1beta1Client{restClients: clients}
}
...
func (c *SchedulingV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *SchedulingV1beta1Client) run() {
	go func(c *SchedulingV1beta1Client) {
