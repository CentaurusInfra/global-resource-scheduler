...
func New(c rest.Interface) *AuthorizationV1Client {
	...
	return &AuthorizationV1Client{restClients: clients}
}
...
func (c *AuthorizationV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *AuthorizationV1Client) run() {
	go func(c *AuthorizationV1Client) {
