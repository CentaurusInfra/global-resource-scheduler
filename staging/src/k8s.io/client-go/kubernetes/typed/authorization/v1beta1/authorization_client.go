...
func NewForConfig(c *rest.Config) (*AuthorizationV1beta1Client, error) {
	...
	obj := &AuthorizationV1beta1Client{
		restClients: clients,
		configs:     configs,
	}
...
func New(c rest.Interface) *AuthorizationV1beta1Client {
	...
	return &AuthorizationV1beta1Client{restClients: clients}
}
...
func (c *AuthorizationV1beta1Client) run() {
	go func(c *AuthorizationV1beta1Client) {
