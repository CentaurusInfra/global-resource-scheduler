...
func New(c rest.Interface) *BatchV2alpha1Client {
	...
	return &BatchV2alpha1Client{restClients: clients}
}
...
func (c *BatchV2alpha1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *BatchV2alpha1Client) run() {
	go func(c *BatchV2alpha1Client) {
