...
func New(c rest.Interface) *BatchV1beta1Client {
	...
	return &BatchV1beta1Client{restClients: clients}
}
...
func (c *BatchV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *BatchV1beta1Client) run() {
	go func(c *BatchV1beta1Client) {
