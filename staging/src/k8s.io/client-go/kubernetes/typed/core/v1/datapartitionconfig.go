...
// DataPartitionConfigsGetter has a method to return a DataPartitionConfigInterface.
// A group's client should implement this interface.
type DataPartitionConfigsGetter interface {
	DataPartitionConfigs() DataPartitionConfigInterface
}

// DataPartitionConfigInterface has methods to work with DataPartitionConfig resources.
type DataPartitionConfigInterface interface {
	Create(*v1.DataPartitionConfig) (*v1.DataPartitionConfig, error)
	Update(*v1.DataPartitionConfig) (*v1.DataPartitionConfig, error)
...
// dataPartitionConfigs implements DataPartitionConfigInterface
type dataPartitionConfigs struct {
	client  rest.Interface
	clients []rest.Interface
}

// newDataPartitionConfigs returns a DataPartitionConfigs
func newDataPartitionConfigs(c *CoreV1Client) *dataPartitionConfigs {
...
func (c *dataPartitionConfigs) List(opts metav1.ListOptions) (result *v1.DataPartitionConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.DataPartitionConfigList{}
	...
	if wgLen > 1 {
		...
		itemsMap := make(map[string]*v1.DataPartitionConfig)
		for j := 0; j < wgLen; j++ {
...
func (c *dataPartitionConfigs) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
