...
func New(c rest.Interface) *AutoscalingV1Client {
	...
	return &AutoscalingV1Client{restClients: clients}
}
...
func (c *AutoscalingV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *AutoscalingV1Client) run() {
	go func(c *AutoscalingV1Client) {
