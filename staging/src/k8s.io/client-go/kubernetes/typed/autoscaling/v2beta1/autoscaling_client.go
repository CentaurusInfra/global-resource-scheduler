...
func (c *AutoscalingV2beta1Client) HorizontalPodAutoscalersWithMultiTenancy(namespace string, tenant string) HorizontalPodAutoscalerInterface {
...
func New(c rest.Interface) *AutoscalingV2beta1Client {
	...
	return &AutoscalingV2beta1Client{restClients: clients}
}
...
func (c *AutoscalingV2beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *AutoscalingV2beta1Client) run() {
	go func(c *AutoscalingV2beta1Client) {
