...
func New(c rest.Interface) *StorageV1beta1Client {
	...
	return &StorageV1beta1Client{restClients: clients}
}
...
func (c *StorageV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *StorageV1beta1Client) run() {
	go func(c *StorageV1beta1Client) {
