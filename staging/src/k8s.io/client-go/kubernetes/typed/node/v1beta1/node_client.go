...
func New(c rest.Interface) *NodeV1beta1Client {
	...
	return &NodeV1beta1Client{restClients: clients}
}
...
func (c *NodeV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *NodeV1beta1Client) run() {
	go func(c *NodeV1beta1Client) {
