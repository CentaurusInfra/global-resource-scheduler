...
func New(c rest.Interface) *CoordinationV1beta1Client {
	...
	return &CoordinationV1beta1Client{restClients: clients}
}
...
func (c *CoordinationV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *CoordinationV1beta1Client) run() {
	go func(c *CoordinationV1beta1Client) {
