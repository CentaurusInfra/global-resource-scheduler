...
func New(c rest.Interface) *CoordinationV1Client {
	...
	return &CoordinationV1Client{restClients: clients}
}
...
func (c *CoordinationV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *CoordinationV1Client) run() {
	go func(c *CoordinationV1Client) {
