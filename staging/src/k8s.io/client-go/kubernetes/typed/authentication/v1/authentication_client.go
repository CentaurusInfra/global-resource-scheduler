...
func New(c rest.Interface) *AuthenticationV1Client {
	...
	return &AuthenticationV1Client{restClients: clients}
}
...
func (c *AuthenticationV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *AuthenticationV1Client) run() {
	go func(c *AuthenticationV1Client) {
