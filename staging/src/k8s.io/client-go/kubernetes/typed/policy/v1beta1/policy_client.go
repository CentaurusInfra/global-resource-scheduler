...
func New(c rest.Interface) *PolicyV1beta1Client {
	...
	return &PolicyV1beta1Client{restClients: clients}
}
...
func (c *PolicyV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *PolicyV1beta1Client) run() {
	go func(c *PolicyV1beta1Client) {
