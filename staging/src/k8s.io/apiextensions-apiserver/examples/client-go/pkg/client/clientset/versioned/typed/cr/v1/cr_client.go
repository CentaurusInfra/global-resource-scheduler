...
func (c *CrV1Client) ExamplesWithMultiTenancy(namespace string, tenant string) ExampleInterface {
	return newExamplesWithMultiTenancy(c, namespace, tenant)
}
...
func New(c rest.Interface) *CrV1Client {
	...
	return &CrV1Client{restClients: clients}
}
...
func (c *CrV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *CrV1Client) run() {
	go func(c *CrV1Client) {
