...
func New(c rest.Interface) *MetricsV1beta1Client {
	...
	return &MetricsV1beta1Client{restClients: clients}
}
...
func (c *MetricsV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *MetricsV1beta1Client) run() {
	go func(c *MetricsV1beta1Client) {
