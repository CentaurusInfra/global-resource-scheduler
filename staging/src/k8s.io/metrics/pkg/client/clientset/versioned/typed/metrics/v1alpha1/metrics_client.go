...
func (c *MetricsV1alpha1Client) PodMetricsesWithMultiTenancy(namespace string, tenant string) PodMetricsInterface {
...
func New(c rest.Interface) *MetricsV1alpha1Client {
	...
	return &MetricsV1alpha1Client{restClients: clients}
}
...
func (c *MetricsV1alpha1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *MetricsV1alpha1Client) run() {
	go func(c *MetricsV1alpha1Client) {
