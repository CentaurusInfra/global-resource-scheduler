...
func NewForConfig(c *rest.Config) (*ApiregistrationV1beta1Client, error) {
	...
	obj := &ApiregistrationV1beta1Client{
		restClients: clients,
		configs:     configs,
	}
...
func New(c rest.Interface) *ApiregistrationV1beta1Client {
	...
	return &ApiregistrationV1beta1Client{restClients: clients}
}
...
func (c *ApiregistrationV1beta1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *ApiregistrationV1beta1Client) run() {
	go func(c *ApiregistrationV1beta1Client) {
