...
type Interface interface {
	// Dispatchers returns a DispatcherInformer.
	Dispatchers() DispatcherInformer
}
...
// Dispatchers returns a DispatcherInformer.
func (v *version) Dispatchers() DispatcherInformer {
	return &dispatcherInformer{factory: v.factory, namespace: v.namespace, tenant: v.tenant, tweakListOptions: v.tweakListOptions}
}
