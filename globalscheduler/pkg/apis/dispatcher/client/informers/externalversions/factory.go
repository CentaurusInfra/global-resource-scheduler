...
import (
	...
	dispatcher "k8s.io/kubernetes/globalscheduler/pkg/apis/dispatcher/client/informers/externalversions/dispatcher"
...
type SharedInformerFactory interface {
	...
	Globalscheduler() dispatcher.Interface
}

func (f *sharedInformerFactory) Globalscheduler() dispatcher.Interface {
	return dispatcher.NewWithMultiTenancy(f, f.namespace, f.tweakListOptions, f.tenant)
}
