...
import (
	...
	cluster "k8s.io/kubernetes/globalscheduler/pkg/apis/cluster/client/informers/externalversions/cluster"
...
type SharedInformerFactory interface {
	...
	Globalscheduler() cluster.Interface
}

func (f *sharedInformerFactory) Globalscheduler() cluster.Interface {
	return cluster.NewWithMultiTenancy(f, f.namespace, f.tweakListOptions, f.tenant)
}
