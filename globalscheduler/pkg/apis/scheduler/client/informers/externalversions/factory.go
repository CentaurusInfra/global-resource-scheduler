...
import (
	...
	scheduler "k8s.io/kubernetes/globalscheduler/pkg/apis/scheduler/client/informers/externalversions/scheduler"
)
...
type SharedInformerFactory interface {
	...
	Globalscheduler() scheduler.Interface
}

func (f *sharedInformerFactory) Globalscheduler() scheduler.Interface {
	return scheduler.NewWithMultiTenancy(f, f.namespace, f.tweakListOptions, f.tenant)
}
