...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DistributorStatus) DeepCopyInto(out *DistributorStatus) {
	*out = *in
	if in.Active != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DistributorStatus.
func (in *DistributorStatus) DeepCopy() *DistributorStatus {
	if in == nil {
		return nil
	}
	out := new(DistributorStatus)
	in.DeepCopyInto(out)
	return out
}
