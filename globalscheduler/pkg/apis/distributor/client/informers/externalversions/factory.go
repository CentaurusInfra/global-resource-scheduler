...
import (
	...
	distributor "k8s.io/kubernetes/globalscheduler/pkg/apis/distributor/client/informers/externalversions/distributor"
...
type SharedInformerFactory interface {
	...
	Globalscheduler() distributor.Interface
}

func (f *sharedInformerFactory) Globalscheduler() distributor.Interface {
	return distributor.NewWithMultiTenancy(f, f.namespace, f.tweakListOptions, f.tenant)
}
