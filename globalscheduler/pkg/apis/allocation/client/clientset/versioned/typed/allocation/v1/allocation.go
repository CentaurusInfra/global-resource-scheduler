...
func newAllocations(c *GlobalschedulerV1Client, namespace string) *allocations {
	return newAllocationsWithMultiTenancy(c, namespace, "system")
}

func newAllocationsWithMultiTenancy(c *GlobalschedulerV1Client, namespace string, tenant string) *allocations {
	return &allocations{
		client:  c.RESTClient(),
