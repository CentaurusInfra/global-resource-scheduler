...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ResourceScheduler)(nil), (*core.ResourceScheduler)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ResourceScheduler_To_core_ResourceScheduler(a.(*v1.ResourceScheduler), b.(*core.ResourceScheduler), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ResourceScheduler)(nil), (*v1.ResourceScheduler)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ResourceScheduler_To_v1_ResourceScheduler(a.(*core.ResourceScheduler), b.(*v1.ResourceScheduler), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ResourceScheduler_To_core_ResourceScheduler(in *v1.ResourceScheduler, out *core.ResourceScheduler, s conversion.Scope) error {
	out.Name = in.Name
	out.Tag = in.Tag
	out.StartTime = (*metav1.Time)(unsafe.Pointer(in.StartTime))
	return nil
...
// Convert_v1_ResourceScheduler_To_core_ResourceScheduler is an autogenerated conversion function.
func Convert_v1_ResourceScheduler_To_core_ResourceScheduler(in *v1.ResourceScheduler, out *core.ResourceScheduler, s conversion.Scope) error {
	return autoConvert_v1_ResourceScheduler_To_core_ResourceScheduler(in, out, s)
}

func autoConvert_core_ResourceScheduler_To_v1_ResourceScheduler(in *core.ResourceScheduler, out *v1.ResourceScheduler, s conversion.Scope) error {
	out.Name = in.Name
	out.Tag = in.Tag
	out.StartTime = (*metav1.Time)(unsafe.Pointer(in.StartTime))
	return nil
...
// Convert_core_ResourceScheduler_To_v1_ResourceScheduler is an autogenerated conversion function.
func Convert_core_ResourceScheduler_To_v1_ResourceScheduler(in *core.ResourceScheduler, out *v1.ResourceScheduler, s conversion.Scope) error {
	return autoConvert_core_ResourceScheduler_To_v1_ResourceScheduler(in, out, s)
}
