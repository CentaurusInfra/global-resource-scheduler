...
func TestHumanReadablePrinterSupportsExpectedOptions(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedOutput: "NAME   HASHKEY   READY   STATUS   RESTARTS   AGE         DISTRIBUTOR   SCHEDULER   DISPATCHER\nfoo    0         0/0              0          <unknown>                             \n",
		},
		{
			name:           "\"wide\" output format prints",
			outputFormat:   "wide",
			expectedOutput: "NAME   HASHKEY   READY   STATUS   RESTARTS   AGE         DISTRIBUTOR   SCHEDULER   DISPATCHER   IP       NODE     NOMINATED NODE   READINESS GATES\nfoo    0         0/0              0          <unknown>                                          <none>   <none>   <none>           <none>\n",
		},
		{
		...
		},
		{
			...
			expectedOutput: "NAME   HASHKEY   READY   STATUS   RESTARTS   AGE         DISTRIBUTOR   SCHEDULER   DISPATCHER   L1\nfoo    0         0/0              0          <unknown>                                          value\n",
		},
		{
			name:           "withNamespace displays an additional NAMESPACE column",
			withNamespace:  true,
			expectedOutput: "NAMESPACE   NAME   HASHKEY   READY   STATUS   RESTARTS   AGE         DISTRIBUTOR   SCHEDULER   DISPATCHER\n            foo    0         0/0              0          <unknown>                             \n",
		},
		{
